...
var fileController = {
  ...
  _createNewFileOrFolder: function (fileInfo) {
    ...
    return new Q()
      ...
      .catch(function (err) {
        console.log('Error Validating fileName', err);
      })
      .then(function () {
        return fileController.getFileStructure(projectId, projectName);
      })
      .catch(function (err) {
        console.log('Error Getting File Structure', err);
      })
      .then(function (fileStructure) {
      ...
      .catch(function (err) {
        console.log('Error Updating FileStructure fileName', err);
      });
  },
  /**
  ...
  moveFileInProject: function (req, res) {
    ...
    return fileController.getFileStructure(null, fileInfo.projectIdOrName)
      ...
      .then(function () {
        return uploadController._addFileWithContentToProject(fileInfo.projectName, newPath, req.user.id, fileContent);
      })
